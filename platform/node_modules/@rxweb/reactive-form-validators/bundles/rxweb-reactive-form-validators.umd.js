(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var ObjectMaker = /** @class */ (function () {
        ...
        ObjectMaker.toJson = function (key, config, values) {
            ...
            if (config && config.messageNexus)
                Object.keys(config.messageNexus).forEach(function (propName) {
        ...
        RxFormBuilder.prototype.addFormControl = function (property, propertyValidators, propValidationConfig, instance, entity) {
            ...
            try {
                for (var propertyValidators_2 = __values(propertyValidators), propertyValidators_2_1 = propertyValidators_2.next(); !propertyValidators_2_1.done; propertyValidators_2_1 = propertyValidators_2.next()) {
                    ...
                    if (!propertyValidator.isAsync) {
                        var config = propertyValidator.config;
                    ...
                    switch (property.propertyType) {
                        case PROPERTY:
                            if (!(entityObject[property.name] instanceof forms.FormControl || entityObject[property.name] instanceof RxFormControl)) {
                                var propertyValidators = instanceContainer.propertyAnnotations.filter(function (t) { return t.propertyName == property.name && t.isValidator; });
                                var updateOn = instanceContainer.propertyAnnotations.filter(function (t) { return t.propertyName == property.name && !t.isValidator && t.annotationType === "updateOn"; })[0];
                                ...
                                if (updateOn && !abstractControlOptions_1.updateOn)
                                    abstractControlOptions_1.updateOn = updateOn.config.runOn;
                        ...
                        case OBJECT_PROPERTY:
                            ...
                            if (!objectValue && property.objectConfig && property.objectConfig.autoCreate)
                                objectValue = _this.createClassObject(property.entity, {});
    ...
    var DecimalProvider = /** @class */ (function () {
        ...
        DecimalProvider.prototype.transFormDecimal = function (value, digitsInfo, persistZero) {
            value = String(value);
            if (!value) {
                return value;
            }
            var transformedValue = this.decimalPipe.transform(value.replace(ReactiveFormConfig.number.groupSymbol, "").replace(this.decimalSeperator, "."), digitsInfo, this.localeId);
            if (persistZero && value.indexOf(this.decimalSeperator)) {
                var splitTransformed = transformedValue.split(".");
                var splitDigitsInfo = digitsInfo ? digitsInfo.split("-") : [];
                var digits = splitDigitsInfo.length > 1 ? parseInt(splitDigitsInfo[splitDigitsInfo.length - 1]) : 0;
                if (splitTransformed.length > 1 && splitDigitsInfo.length > 0 && digits !== 0 && splitTransformed[1].length !== digits) {
                    var diff = digits - splitTransformed[1].length;
        ...
        RxFormControlDirective.prototype.blurEvent = function () {
            if (!(this.formControl && this.formControl.errors && this.formControl.errors.numeric)) {
                if (this.formControl.value !== null && this.formControl.value !== undefined) {
                    var value = this.decimalProvider.transFormDecimal(this.formControl.value, this.rxnumeric.digitsInfo, this.rxnumeric.persistZero);
