"use strict";
(self["webpackChunkplatform"] = self["webpackChunkplatform"] || []).push([["src_main_webapp_app_admin_admin-routing_module_ts"],{
            ...
            _angular_router__WEBPACK_IMPORTED_MODULE_1__.RouterModule.forChild([
                {
                    ...
                    loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_main_webapp_app_admin_user-management_user-management_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./user-management/user-management.module */ 8483)).then(m => m.UserManagementModule),
                    data: {
                ...
                {
                    path: 'admin-task',
                    loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_main_webapp_app_admin_admin-task_admin-task_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./admin-task/admin-task.module */ 9026)).then(m => m.AdminTaskModule),
                },
